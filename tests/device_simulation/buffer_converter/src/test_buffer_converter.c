...
void ztest_partial_block(struct buffer_converter *converter,
...
void ztest_whole_blocks(struct buffer_converter *converter,
...
void ztest_empty_push_and_pull(struct buffer_converter *converter)
{
  char buf[1];
  int ret;
